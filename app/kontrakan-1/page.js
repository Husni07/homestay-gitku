...
export const metadata = {
  title:
    "Kontrakan 1: Penginapan dekat spot wisata Pantai Karang Jahe (KJB)",
  description:
    "Kontrakan 1 adalah penginapan yang sangat terjangkau dan terletak di lokasi yang strategis dekat dengan spot wisata Pantai Karang Jahe (KJB), Sangat cocok untuk yang mau liburan di kota Tiongkok kecil (Rembang)",
};
      ...
      <section className="relative py-16 bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
        <div className="flex justify-center mb-8">
          <div className="font-bold w-[80%] text-black z-10 flex justify-center flex-col items-center text-center">
            <h1 className="mb-4 text-4xl">Kontrakan 1</h1>
            <p className="px-5 text-base">
              Kontrakan 1 adalah penginapan yang sangat terjangkau dan
