...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col px-10 pt-4 bg-gradient-to-r from-gray-300 via-[#bce1ff] to-gray-300">
      ...
      <div className="flex flex-col h-auto lg:gap-10 lg:flex-row">
        <div className="flex flex-col mx-auto h-80 lg:w-2/5">
          <div className="mb-2">
          ...
          <div className="mb-2">
            <h1 className="text-lg font-bold">
              Telepon :&nbsp;
              <span className="text-base font-normal">08xxxxxxxxxxxxxxx</span>
            </h1>
          </div>
          <div className="mb-2">
            <h1 className="text-lg font-bold">
          ...
          <div className="mb-2">
            <h1 className="text-lg font-bold">
              Facebook :&nbsp;
              <span className="text-base font-normal">FatayaHomestay</span>
            </h1>
          </div>
          <div className="mb-2">
            <h1 className="text-lg font-bold">
              Tiktok :&nbsp;
              <span className="text-base font-normal">@Fataya</span>
            </h1>
          </div>
        </div>
        <div className="flex lg:w-3/5" id="lokasi">
          <iframe
