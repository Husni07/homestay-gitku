...
export default function RoomPage() {
  ...
  return (
    <div className="">
      ...
      {/* <Hero /> */}
      <section className="lg:sticky relative top-0 py-16 bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
      ...
      <div className="flex flex-col lg:flex-row w-full gap-10 px-5 mx-auto lg:max-w-7xl sm:px-10 md:px-12 lg:px-10">
      ...
      <section className="relative flex flex-col bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 w-full p-4 py-6 lg:py-16" id="galery">
        {/* <span className="absolute w-4/12 rotate-90 skew-x-12 skew-y-12 rounded-full lg:w-2/12 aspect-square bg-gradient-to-tr from-blue-600 to-green-400 -top-5 lg:left-0 blur-2xl opacity-40"></span> */}
